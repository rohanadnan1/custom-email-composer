 ...
 * Features:
 * 1. Floating Position (Bottom-Right)
 * 2. Pre-filled Message Support
...
// Hover effect handling (Optional: You can use Tailwind classes if installed)
/* Agar aap Tailwind use kar rahe hain, toh sirf ye classes add karein:
